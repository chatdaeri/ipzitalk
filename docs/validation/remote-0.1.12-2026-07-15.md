...
0.1.11 기존 산출물의 정적 감사는 [별도 감사 기록](remote-0.1.11-artifact-audit-2026-07-15.md)으로 완료했다. HTML/JSON 5/5 일치, 동적 파일명 5/5, 사용자 HTML 금지 패턴 0건, XLSX 9·10시트 유효성을 확인했다. 아래 항목은 0.1.11에서 발견해 0.1.12에서 수정한 지점만 다시 확인하는 집중 회귀다.
