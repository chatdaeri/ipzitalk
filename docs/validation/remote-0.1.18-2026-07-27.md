...
- `MAPPING_REVIEW_REQUIRED` 이름 fallback 금지
- `PARTIAL_COVERAGE`·truncation을 완전한 기간 집계와 구분
- Remote 플러그인 0.1.18 및 Skill 소스 커밋 `0bbd319be1562835387ae351497deea1d9ae5baf` 잠금
...
- 검토 필요 단지: 매매·전월세 모두 `MAPPING_REVIEW_REQUIRED`, 단지명 fallback 없음
