...
| 버전 | 날짜 | 내용 |
|---|---|---|
| 1.1.7 | 2026-07-27 | review 매핑에는 exact 법정동·전체 지번·K-apt 공식명 제한 조회를 허용하고 기본 14회·최대 16회로 고정 |
| 1.1.6 | 2026-07-27 | 매매·전월세는 `kapt_code` 12개월 범위 조회로 전환하고 분양권만 확정 단지명 경로를 유지. 기본 호출을 23→14회로 축소 |
