...
assert(sourceLock.plugins.remote.version === '0.1.18', 'kapt-code Remote package must be version 0.1.18');
...
assert(lockedSkillVersions['ipzitalk-complex-overview-all'] === '1.1.6', 'complex-overview-all kapt-code version mismatch');
...
assert(lockedSkillVersions['ipzitalk-price-trend'] === '1.2.6', 'price-trend kapt-code version mismatch');
