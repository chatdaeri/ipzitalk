...
assert(setupSkill.includes('기존 Claude Code를 완전히 종료하고'), 'setup must require a fresh Claude process after external OAuth login');
...
assert(sourceLock.plugins.launcher.version === '0.1.5', 'OAuth new-session launcher package must be version 0.1.5');
